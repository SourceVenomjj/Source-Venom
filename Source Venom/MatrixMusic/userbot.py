...
class Userbot(Client):
    ...
    async def start(self):
        LOGGER("ميــوزك فينوم ").info(f"جارِ تشغيل الحساب المساعد . . .")
        if config.STRING1:
            ...
            LOGGER("ميــوزك فينوم ").info(f"تم بدء تشغيل الحساب المساعد {self.one.name} ...✓")
        ...
        if config.STRING2:
            ...
            LOGGER("ميــوزك فينوم ").info(f"Assistant Two Started as {self.two.name}")
        ...
        if config.STRING3:
            ...
            LOGGER("ميــوزك فينوم ").info(f"Assistant Three Started as {self.three.name}")
        ...
        if config.STRING4:
            ...
            LOGGER("ميــوزك فينوم ").info(f"Assistant Four Started as {self.four.name}")
        ...
        if config.STRING5:
            ...
            LOGGER("ميــوزك فينوم ").info(f"Assistant Five Started as {self.five.name}")

    async def stop(self):
        LOGGER("ميــوزك فينوم ").info(f"Stopping Assistants...")
        try:
            if config.STRING1:
                await self.one.stop()
            if config.STRING2:
